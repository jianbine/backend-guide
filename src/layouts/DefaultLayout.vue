...
const navItems = [
  ...
  { path: '/chapter/10-graphql', label: 'API 设计进阶', icon: '🔮', chapter: '10' },
  { path: '/chapter/11-advanced-api', label: '接口进阶实战', icon: '🛠️', chapter: '11' },
  { path: '/chapter/12-microservice', label: '微服务基础', icon: '🌐', chapter: '12' },
  { path: '/chapter/13-testing', label: '测试与质量保障', icon: '✅', chapter: '13' },
]
